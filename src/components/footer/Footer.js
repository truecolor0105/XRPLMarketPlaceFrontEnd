    ...
    return (
        <div className="bg-[#121212] w-full py-2">
            <div className="pt-10 w-full flex">
                <div className="w-full gap-12 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
                    <div className="w-full">
                        ...
                        <div className="text-start text-xl py-8 text-white">xMart - A community focused NFT market place, brnging unility to those who need it most.</div>
                    </div>
                    ...
                    <ul className="w-full text-white text-start items-center">
                        ...
                        <li className="text-cm py-1">Join our list and we'll keep you up to date on the latest & greatest features in xMart. We will NOT spam you and your email address wil not be shared with 3rd party.</li>
                        <div className="flex text-end py-12">
                            <input className="text-[#edb731] w-full rounded-l-[15px] text-xl pl-3" ></input>
            ...
            <div className="text-center mt-32 py-8 border-t-2 border-t-black flex items-center justify-center text-[#edb731] text-xl">
                <div className="gap-2 flex items-center"><BiCopyright />2021-2023 xmart, All Rights Reserved. v1.0</div>
            </div>
        </div>
    )
}